...
LINK++ = $(call quiet-command,$(CXX) $(QEMU_CFLAGS) $(CFLAGS) $(LDFLAGS) -L$(GREENSOCS_LIB) -L$(SYSTEMC_LIB) -o $@ $(sort $(filter %.o, $1)) $(filter-out %.o, $1) $(LIBS) -lsystemc -lgreenreg,"  LINK+ $(TARGET_DIR)$@")
